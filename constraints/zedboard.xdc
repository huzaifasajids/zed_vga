...
set_property PACKAGE_PIN AA19 [get_ports {o_vga_hsync}];  # "VGA-HS"
...
set_property PACKAGE_PIN Y19  [get_ports {o_vga_vsync}];  # "VGA-VS"
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {i_rst}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {i_grayscale}];  # "SW1"
